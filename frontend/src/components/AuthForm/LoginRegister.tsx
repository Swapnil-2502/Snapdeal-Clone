      ...
      <>
          ...
          <div className="login-register-common">
              ...
              <form id="commonView" onSubmit={handleSubmit}>	
                  ...
                  <div className="loginSocialBtn col-xs-24 reset-padding marT20 marB20">
                      <div className="commonTextGrey aligncenter">or Login Using </div>
                      <div className="social-button gmLogin rfloat col-xs-11" id="googleUserLogin" style={{width:"100%"}}>
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 48 48" className="social-icon">
                          <g>
